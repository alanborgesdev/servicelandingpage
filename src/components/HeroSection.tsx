...
const HeroSection = () => {
    const stats = [
        { value: "SEO", label: "Encontrado no Google" },
        { value: "Velocidade", label: "Rápido" },
        { value: "UX/UI", label: "Fácil de Usar" },
    ];
            ...
            <div className="container mx-auto px-6 relative z-20">
                <div className="max-w-4xl mx-auto text-center">
                    ...
                    <p className="text-lg md:text-xl text-muted-foreground max-w-2xl mx-auto mb-10 opacity-0 animate-fade-in-up animation-delay-200">
                        Transforme visitantes em clientes com páginas de alta
                        conversão. Design moderno, otimizadas para resultados e
                        entrega rápida.
                    </p>
                    ...
                    <div className="flex flex-col sm:flex-row gap-4 justify-center opacity-0 animate-fade-in-up animation-delay-300">
                        <Button variant="hero" size="xl" asChild>
                            <a
                                ...
                                aria-label="Solicitar orçamento para criação de landing page"
                            >
                                Solicitar Orçamento
