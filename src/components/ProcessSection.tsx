...
import { MessageSquare, Palette, LayoutGrid, Smartphone, CheckCircle } from 'lucide-react';
...
const ProcessSection = () => {
    const steps = [
        {
            ...
            description: 'Entendo o objetivo do cliente e o que a landing page precisa comunicar.',
        },
        {
            icon: Palette,
        ...
        },
        {
            ...
            description: 'Organizo as seções estrategicamente para gerar clareza e conversão.',
        },
        {
            icon: Smartphone,
        ...
        },
        {
            ...
            description: 'Faço revisões necessárias até a página estar perfeita para publicação.',
        },
    ];
    ...
    return (
        <Section
            ...
            title={
                <>
                    Meu Processo de <span className="text-gradient-gold">Criação</span>
                </>
            }
            description="Um método claro e eficiente para entregar landing pages profissionais e focadas em conversão."
        >
            <FeatureGrid features={steps} columns={5} variant="numbered" showConnectors={true} />
        </Section>
    );
};
